...
public class AppmartInBilling {
		...
		/* private Constructor */
		private AppmartInBilling(Context context) {
			mContext = context ;
		}
		
		/* インスタンス取得 */
		public static AppmartInBilling getInstance(Context context){ 		
			return new AppmartInBilling(context);					
		}
		
		/* パラメータ設定 */
		public AppmartInBilling setParameters(String devId,String  licenceKey, String  publicKey, String appId){
			this.devId=devId;
